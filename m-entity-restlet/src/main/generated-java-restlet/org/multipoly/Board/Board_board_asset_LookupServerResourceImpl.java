...
public class Board_board_asset_LookupServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_asset_LookupServerResourceImpl
	 */
	public Board_board_asset_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
