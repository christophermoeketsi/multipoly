...
public class UserGroups_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for UserGroups_ServerResourceImpl
	 */
	public UserGroups_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<UserGroup> resource = (UmlgSet<UserGroup>)UserGroup.allInstances();
			json.append("[");
			json.append("{\"data\": [");
			json.append(ToJsonUtil.toJsonWithoutCompositeParent(resource));
			json.append("], \"meta\": {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::UserGroup\"");
	...
	private UmlgNode add(Map<String,Object> propertyMap) {
		UserGroup childResource = new UserGroup(true);
