...
public class Board_board_edward_lookUpForOne_ServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_edward_lookUpForOne_ServerResourceImpl
	 */
	public Board_board_edward_lookUpForOne_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			json.append("{\"data\": [");
			json.append(UmlgRestletToJsonUtil.toJson(resource.lookupFor_board_edward()));
			json.append("],");
			json.append(" \"meta\" : {");
