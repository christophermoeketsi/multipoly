...
public class Users_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for Users_ServerResourceImpl
	 */
	public Users_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<User> resource = (UmlgSet<User>)User.allInstances();
			json.append("[");
			json.append("{\"data\": [");
			json.append(ToJsonUtil.toJsonWithoutCompositeParent(resource));
			json.append("], \"meta\": {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::User\"");
	...
	private UmlgNode add(Map<String,Object> propertyMap) {
		User childResource = new User(true);
