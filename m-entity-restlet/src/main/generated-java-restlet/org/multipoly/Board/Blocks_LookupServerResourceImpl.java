...
public class Blocks_LookupServerResourceImpl extends ServerResource implements Blocks_LookupServerResource {


	/**
	 * default constructor for Blocks_LookupServerResourceImpl
	 */
	public Blocks_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(Map<String,Object> propertyMap) {
		Block childResource = new Block(true);
