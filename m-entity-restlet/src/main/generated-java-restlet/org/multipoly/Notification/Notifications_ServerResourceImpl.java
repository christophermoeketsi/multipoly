...
public class Notifications_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for Notifications_ServerResourceImpl
	 */
	public Notifications_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<Notification> resource = (UmlgSet<Notification>)Notification.allInstances();
			json.append("[");
			json.append("{\"data\": [");
	...
	private UmlgNode add(Map<String,Object> propertyMap) {
		Notification childResource = new Notification(true);
