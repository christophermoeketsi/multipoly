...
import org.multipoly.ROLE.ROLERuntimePropertyEnum;
...
public class ROLE_role_user_ServerResourceImpl extends ServerResource {
	...
	public Representation get() throws ResourceException {
		try {
			...
			json.append("],");
			json.append(" \"meta\" : {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::ROLE::user\"");
	...
	public Representation options() throws ResourceException {
		try {
			...
			json.append(", \"from\": ");
			json.append(ROLERuntimePropertyEnum.asJson());
			json.append("}}");
			json.append("]");
			return new JsonRepresentation(json.toString());
		} finally {
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends User> baseClass : resultMap.keySet() ) {
				...
				result.append("],");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::ROLE::user\"");
				result.append(", \"to\": ");
				if ( baseClass.equals(User.class) ) {
					result.append(UserRuntimePropertyEnum.asJson());
					result.append(", \"from\": ");
					result.append(ROLERuntimePropertyEnum.asJson());
					result.append("}");
					result.append("");
				} else {
	...
	private void add(Map<Class<? extends User>,List<UmlgNodeJsonHolder>> resultMap, ROLE parentResource, Map<String,Object> propertyMap) {
