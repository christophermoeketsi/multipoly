...
public class Board_board_block_ServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_block_ServerResourceImpl
	 */
	public Board_board_block_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			json.append("[");
			json.append("{\"data\": ");
			if ( parentResource.getBlock() != null && parentResource.getBlock().getClass() == Block.class ) {
				json.append(ToJsonUtil.toJsonWithoutCompositeParent(parentResource.getBlock()));
			} else {
				json.append("null");
			}
			json.append(",");
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends Block> baseClass : resultMap.keySet() ) {
				...
				result.append(",");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::Board::block\"");
				result.append(", \"to\": ");
	...
	private void add(Map<Class<? extends Block>,List<UmlgNodeJsonHolder>> resultMap, Board parentResource, Map<String,Object> propertyMap) {
