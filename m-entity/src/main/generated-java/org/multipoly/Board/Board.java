...
public class Board extends BaseUmlgCompositionNode implements UmlgRestletNode, UmlgRootNode, CompositionNode {
	...
	public void addToEdward(Edward edward) {
		if ( edward != null ) {
			if ( !this.edward.isEmpty() ) {
				throw new RuntimeException("Property RootElement::org::multipoly::Board::Board::edwardis a one and already has a value!");
			}
			this.edward.add(edward);
		}
	}
	
	public void addToEdwardIgnoreInverse(Edward edward) {
		if ( edward != null ) {
			if ( !this.edward.isEmpty() ) {
				throw new RuntimeException("Property RootElement::org::multipoly::Board::Board::edwardis a one and already has a value!");
			}
			this.edward.addIgnoreInverse(edward);
		}
	}
	...
	public void fromJsonNonCompositeOne(Map<String,Object> propertyMap) {
		...
		if ( propertyMap.containsKey("edward") ) {
			if ( propertyMap.get("edward") != null ) {
				Map<String, Object> edwardMap = (Map<String, Object>)propertyMap.get("edward");
				if ( edwardMap.isEmpty() || edwardMap.get("id") == null ) {
					setEdward(null);
				} else {
					Object id;
					Object idFromMap = edwardMap.get("id");
					if ( (idFromMap instanceof String) && ((String)idFromMap).startsWith("fake") ) {
						id = UmlgTmpIdManager.INSTANCE.get((String)idFromMap);
					} else {
						id = idFromMap;
					}
					setEdward((Edward)UMLG.get().getEntity(id));
				}
			} else {
				setEdward(null);
			}
	...
	public Edward getEdward() {
		UmlgSet<Edward> tmp = this.edward;
		if ( !tmp.isEmpty() ) {
			return tmp.iterator().next();
		} else {
			return null;
	...
	public void initialiseProperties() {
		...
		this.edward =  new UmlgSetImpl<Edward>(this, BoardRuntimePropertyEnum.edward);
	...
	public UmlgRuntimeProperty inverseAdder(UmlgRuntimeProperty tumlRuntimeProperty, boolean inverse, UmlgNode umlgNode) {
		...
		if ( runtimeProperty != null ) {
			switch ( runtimeProperty ) {
				...
				case edward:
					this.edward.inverseAdder((Edward)umlgNode);
					break;
	...
	public UmlgSet<Edward> lookupFor_board_edward() {
		UmlgSet<Edward> result = new UmlgMemorySet<Edward>();
		Filter<Edward> filter = new Filter<Edward>() {
		    @Override
		    public boolean filter(Edward entity){
		        return entity.getBoard() == null;
		    }
		};
		result.addAll(org.multipoly.Board.Edward.allInstances(filter));
		return result;
	}
	...
	public void removeFromEdward(Edward edward) {
		if ( edward != null ) {
			this.edward.remove(edward);
		}
	}
	
	public void removeFromEdward(UmlgSet<Edward> edward) {
		if ( !edward.isEmpty() ) {
			this.edward.removeAll(edward);
		}
	}
	...
	public void setEdward(Edward edward) {
		if ( edward != null ) {
			edward.clearBoard();
			edward.initialiseProperty(EdwardRuntimePropertyEnum.board, false);
		}
		clearEdward();
		addToEdward(edward);
	}
	...
	public String toJson(Boolean deep) {
		...
		sb.append(", ");
		if ( getEdward() != null ) {
			if ( UmlgTmpIdManager.INSTANCE.get(getEdward().getId()) != null ) {
				sb.append("\"edward\": " + "{\"id\": \"" + getEdward().getId() + "\", \"tmpId\": \"" + UmlgTmpIdManager.INSTANCE.get(getEdward().getId())  + "\",\"displayName\": \"" + getEdward().getName() + "\"}" + "");
			} else {
				sb.append("\"edward\": " + "{\"id\": \"" + getEdward().getId() + "\", \"displayName\": \"" + getEdward().getName() + "\"}" + "");
			}
		} else {
			sb.append("\"edward\": " + "{\"id\": " + null + ", \"displayName\": " + null + "}");
		}
		sb.append(", ");
	...
	public List<UmlgConstraintViolation> validateMultiplicities() {
		...
		if ( getEdward() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::Board::Board::edward", "lower multiplicity is 1"));
		}
		if ( getName() == null ) {
	...
	static public enum BoardRuntimePropertyEnum implements UmlgRuntimeProperty {
		...
		edward(/* qualifiedName */ "RootElement::org::multipoly::Board::Board::edward",/* persistentName */ "edward",/* inverseName */ "board",/* inverseQualifiedName */ "RootElement::org::multipoly::Board::Edward::board",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("eddie_board"),/* isOneToOne */ true,/* isOneToMany */ false,/* isManyToOne */ false,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Edward.class,/* json */ "{\"name\": \"edward\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::Board::Board::edward\", \"persistentName\": \"edward\", \"inverseName\": \"board\", \"inverseQualifiedName\": \"RootElement::org::multipoly::Board::Edward::board\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"eddie_board\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/boards/{boardId}/edward\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/boards/{boardId}/edward\", \"tumlMetaDataUri\": \"/RootElement/edwardMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"/RootElement/boards/{boardId}/lookupFor_board_edward\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/boards/{boardId}/edward",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/boards/{boardId}/edward",/* tumlMetaDataUri */ "/RootElement/edwardMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "/RootElement/boards/{boardId}/lookupFor_board_edward",/* tumlCompositeParentLookupUri */ ""),
		...
		public String getLookupFor_board_edward() {
			return this.tumlLookupUri;
		}
