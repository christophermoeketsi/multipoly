...
public class User extends BaseUmlgCompositionNode implements UmlgRestletNode, UmlgRootNode, CompositionNode {
	...
	private UmlgSet<Integer> LastLoggedOut;
	private UmlgSet<Boolean> Rogue;
	private UmlgSet<UserGroup> usergroup;
	private UmlgSet<ROLE> usertype;
	private UmlgSet<Board> board;
	private UmlgSet<String> Surname;
	...
	public void addToBoard(Board board) {
		if ( board != null ) {
			if ( !this.board.isEmpty() ) {
				throw new RuntimeException("Property RootElement::org::multipoly::User::User::boardis a one and already has a value!");
			}
	...
	public void addToEmail(String Email) {
		...
		if ( Email != null ) {
			List<UmlgConstraintViolation> violations = validateEmail(Email);
	...
	public void addToLastLoggedOut(Integer LastLoggedOut) {
		if ( !this.LastLoggedOut.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( LastLoggedOut != null ) {
			List<UmlgConstraintViolation> violations = validateLastLoggedOut(LastLoggedOut);
			if ( violations.isEmpty() ) {
				this.LastLoggedOut.add(LastLoggedOut);
			} else {
				throw new UmlgConstraintViolationException(violations);
			}
		}
	...
	public void addToLastLoggedOutIgnoreInverse(Integer LastLoggedOut) {
		if ( !this.LastLoggedOut.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( LastLoggedOut != null ) {
	...
	public void addToSurname(String Surname) {
		if ( !this.Surname.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( Surname != null ) {
			List<UmlgConstraintViolation> violations = validateSurname(Surname);
			if ( violations.isEmpty() ) {
	...
	public void addToSurnameIgnoreInverse(String Surname) {
		if ( !this.Surname.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( Surname != null ) {
	...
	public void addToUsergroup(UserGroup usergroup) {
		if ( usergroup != null ) {
			if ( !this.usergroup.isEmpty() ) {
				throw new RuntimeException("Property RootElement::org::multipoly::User::User::usergroupis a one and already has a value!");
			}
	...
	public void addToUsertype(ROLE usertype) {
		if ( !this.usertype.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( usertype != null ) {
			List<UmlgConstraintViolation> violations = validateUsertype(usertype);
			if ( violations.isEmpty() ) {
	...
	public void addToUsertypeIgnoreInverse(ROLE usertype) {
		if ( !this.usertype.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( usertype != null ) {
	...
	public void clearLastLoggedOut() {
		this.LastLoggedOut.clear();
	}
	...
	public void fromJsonDataTypeAndComposite(Map<String,Object> propertyMap) {
		Number LastLoggedOutAsNumber = (Number)propertyMap.get("LastLoggedOut");
		...
		if ( propertyMap.containsKey("LastLoggedOut") ) {
			if ( propertyMap.get("LastLoggedOut") != null ) {
				Integer LastLoggedOut = LastLoggedOutAsNumber != null ? LastLoggedOutAsNumber.intValue() : null;
				setLastLoggedOut(LastLoggedOut);
			} else {
				setLastLoggedOut(null);
			}
		}
		...
		if ( propertyMap.containsKey("Surname") ) {
			if ( propertyMap.get("Surname") != null ) {
				String Surname = (String)propertyMap.get("Surname");
				setSurname(Surname);
			} else {
				setSurname(null);
			}
		}
		if ( propertyMap.containsKey("usertype") ) {
			if ( propertyMap.get("usertype") != null ) {
				ROLE usertype = ROLE.fromJson((String)propertyMap.get("usertype"));
	...
	public Integer getLastLoggedOut() {
		UmlgSet<Integer> tmp = this.LastLoggedOut;
		if ( !tmp.isEmpty() ) {
			return tmp.iterator().next();
		} else {
			return null;
	...
	public String getQualifiedName() {
		return "RootElement::org::multipoly::User::User";
	}
	...
	public String getSurname() {
		UmlgSet<String> tmp = this.Surname;
		if ( !tmp.isEmpty() ) {
			return tmp.iterator().next();
		} else {
			return null;
	...
	public ROLE getUsertype() {
		UmlgSet<ROLE> tmp = this.usertype;
		if ( !tmp.isEmpty() ) {
			return tmp.iterator().next();
		} else {
			return null;
	...
	public void initialiseProperties() {
		...
		this.board =  new UmlgSetImpl<Board>(this, UserRuntimePropertyEnum.board);
		...
		this.LastLoggedOut =  new UmlgSetImpl<Integer>(this, UserRuntimePropertyEnum.LastLoggedOut);
		...
		this.Surname =  new UmlgSetImpl<String>(this, UserRuntimePropertyEnum.Surname);
		this.usergroup =  new UmlgSetImpl<UserGroup>(this, UserRuntimePropertyEnum.usergroup);
		this.usertype =  new UmlgSetImpl<ROLE>(this, UserRuntimePropertyEnum.usertype);
		this.Email =  new UmlgSetImpl<String>(this, UserRuntimePropertyEnum.Email);
	...
	public UmlgSet<Board> lookupFor_user_board() {
	...
	public UmlgSet<UserGroup> lookupFor_user_usergroup() {
		...
		result.addAll(org.multipoly.User.UserGroup.allInstances(filter));
		return result;
	}
	...
	public void removeFromEmail(UmlgSet<String> Email) {
		if ( !Email.isEmpty() ) {
	...
	public void removeFromLastLoggedOut(Integer LastLoggedOut) {
		if ( LastLoggedOut != null ) {
			this.LastLoggedOut.remove(LastLoggedOut);
		}
	}
	
	public void removeFromLastLoggedOut(UmlgSet<Integer> LastLoggedOut) {
		if ( !LastLoggedOut.isEmpty() ) {
			this.LastLoggedOut.removeAll(LastLoggedOut);
		}
	}
	...
	public void removeFromSurname(String Surname) {
		if ( Surname != null ) {
			this.Surname.remove(Surname);
		}
	}
	
	public void removeFromSurname(UmlgSet<String> Surname) {
		if ( !Surname.isEmpty() ) {
			this.Surname.removeAll(Surname);
		}
	}
	...
	public void removeFromUsertype(ROLE usertype) {
		if ( usertype != null ) {
			this.usertype.remove(usertype);
		}
	}
	
	public void removeFromUsertype(UmlgSet<ROLE> usertype) {
		if ( !usertype.isEmpty() ) {
			this.usertype.removeAll(usertype);
		}
	}
	...
	public void setLastLoggedOut(Integer LastLoggedOut) {
		clearLastLoggedOut();
		addToLastLoggedOut(LastLoggedOut);
	}
	...
	public String toJson(Boolean deep) {
		...
		sb.append(", ");
		sb.append("\"LastLoggedOut\": " + getLastLoggedOut() + "");
		sb.append(", ");
		sb.append("\"Rogue\": " + getRogue() + "");
		sb.append(", ");
		sb.append("\"Surname\": " + (getSurname() != null ? "\"" + StringEscapeUtils.escapeJson(getSurname()) + "\"" : null ));
		sb.append(", ");
		...
		sb.append(", ");
		sb.append("\"usertype\": " + (getUsertype() == null ? null : "\"" + getUsertype().toJson() + "\""));
		sb.append(", ");
		sb.append("\"Email\": " + (getEmail() != null ? "\"" + StringEscapeUtils.escapeJson(getEmail()) + "\"" : null ));
		sb.append(", ");
	...
	public List<UmlgConstraintViolation> validateEmail(String Email) {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		return result;
	}
	...
	public List<UmlgConstraintViolation> validateLastLoggedOut(Integer LastLoggedOut) {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		return result;
	}
	...
	public List<UmlgConstraintViolation> validateMultiplicities() {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		if ( getUsername() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Username", "lower multiplicity is 1"));
		}
		if ( getBoard() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::board", "lower multiplicity is 1"));
		}
		if ( getPassword() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Password", "lower multiplicity is 1"));
		}
		if ( getName() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Name", "lower multiplicity is 1"));
		}
		if ( getLastLoggedOut() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::LastLoggedOut", "lower multiplicity is 1"));
		}
		if ( getRogue() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Rogue", "lower multiplicity is 1"));
		}
		if ( getSurname() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Surname", "lower multiplicity is 1"));
		}
		if ( getUsergroup() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::usergroup", "lower multiplicity is 1"));
		}
		if ( getUsertype() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::usertype", "lower multiplicity is 1"));
		}
		if ( getEmail() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::Email", "lower multiplicity is 1"));
		}
		if ( getLastLoggedIn() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::User::User::LastLoggedIn", "lower multiplicity is 1"));
		}
		return result;
	}
	...
	public List<UmlgConstraintViolation> validateSurname(String Surname) {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		return result;
	}
	...
	public List<UmlgConstraintViolation> validateUsertype(ROLE usertype) {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		return result;
	}

	static public enum UserRuntimePropertyEnum implements UmlgRuntimeProperty {
		Username(/* qualifiedName */ "RootElement::org::multipoly::User::User::Username",/* persistentName */ "Username",/* inverseName */ "inverseOf::Username",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Username",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Username"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Username\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Username\", \"persistentName\": \"Username\", \"inverseName\": \"inverseOf::Username\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Username\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Username\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Username\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Username\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Username",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Username",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		board(/* qualifiedName */ "RootElement::org::multipoly::User::User::board",/* persistentName */ "board",/* inverseName */ "user",/* inverseQualifiedName */ "RootElement::org::multipoly::Board::Board::user",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ false,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("user_board"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ -1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Board.class,/* json */ "{\"name\": \"board\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::board\", \"persistentName\": \"board\", \"inverseName\": \"user\", \"inverseQualifiedName\": \"RootElement::org::multipoly::Board::Board::user\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": false, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": -1, \"label\": \"user_board\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/board\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/board\", \"tumlMetaDataUri\": \"/RootElement/boardMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"/RootElement/users/{userId}/lookupFor_user_board\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/board",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/board",/* tumlMetaDataUri */ "/RootElement/boardMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "/RootElement/users/{userId}/lookupFor_user_board",/* tumlCompositeParentLookupUri */ ""),
		Password(/* qualifiedName */ "RootElement::org::multipoly::User::User::Password",/* persistentName */ "Password",/* inverseName */ "inverseOf::Password",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Password",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Password"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Password\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Password\", \"persistentName\": \"Password\", \"inverseName\": \"inverseOf::Password\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Password\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Password\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Password\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Password\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Password",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Password",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		Name(/* qualifiedName */ "RootElement::org::multipoly::User::User::Name",/* persistentName */ "Name",/* inverseName */ "inverseOf::Name",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Name",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Name"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Name\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Name\", \"persistentName\": \"Name\", \"inverseName\": \"inverseOf::Name\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Name\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Name\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Name\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Name\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Name",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Name",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		LastLoggedOut(/* qualifiedName */ "RootElement::org::multipoly::User::User::LastLoggedOut",/* persistentName */ "LastLoggedOut",/* inverseName */ "inverseOf::LastLoggedOut",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::LastLoggedOut",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("LastLoggedOut"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Integer.class,/* json */ "{\"name\": \"LastLoggedOut\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::LastLoggedOut\", \"persistentName\": \"LastLoggedOut\", \"inverseName\": \"inverseOf::LastLoggedOut\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::LastLoggedOut\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"LastLoggedOut\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/LastLoggedOut\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/LastLoggedOut\", \"tumlMetaDataUri\": \"/RootElement/integerMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/LastLoggedOut",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/LastLoggedOut",/* tumlMetaDataUri */ "/RootElement/integerMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		Rogue(/* qualifiedName */ "RootElement::org::multipoly::User::User::Rogue",/* persistentName */ "Rogue",/* inverseName */ "inverseOf::Rogue",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Rogue",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Rogue"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Boolean.class,/* json */ "{\"name\": \"Rogue\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Rogue\", \"persistentName\": \"Rogue\", \"inverseName\": \"inverseOf::Rogue\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Rogue\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Rogue\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Rogue\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Rogue\", \"tumlMetaDataUri\": \"/RootElement/booleanMetaData\", \"fieldType\": \"" + FieldType.Boolean + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Rogue",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Rogue",/* tumlMetaDataUri */ "/RootElement/booleanMetaData",/* fieldType */ FieldType.Boolean,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		Surname(/* qualifiedName */ "RootElement::org::multipoly::User::User::Surname",/* persistentName */ "Surname",/* inverseName */ "inverseOf::Surname",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Surname",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Surname"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Surname\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Surname\", \"persistentName\": \"Surname\", \"inverseName\": \"inverseOf::Surname\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Surname\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Surname\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Surname\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Surname\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Surname",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Surname",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		usergroup(/* qualifiedName */ "RootElement::org::multipoly::User::User::usergroup",/* persistentName */ "usergroup",/* inverseName */ "user",/* inverseQualifiedName */ "RootElement::org::multipoly::User::UserGroup::user",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ false,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("userGroup_user"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ -1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ UserGroup.class,/* json */ "{\"name\": \"usergroup\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::usergroup\", \"persistentName\": \"usergroup\", \"inverseName\": \"user\", \"inverseQualifiedName\": \"RootElement::org::multipoly::User::UserGroup::user\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": false, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": -1, \"label\": \"userGroup_user\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/usergroup\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/usergroup\", \"tumlMetaDataUri\": \"/RootElement/userGroupMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"/RootElement/users/{userId}/lookupFor_user_usergroup\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/usergroup",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/usergroup",/* tumlMetaDataUri */ "/RootElement/userGroupMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "/RootElement/users/{userId}/lookupFor_user_usergroup",/* tumlCompositeParentLookupUri */ ""),
		usertype(/* qualifiedName */ "RootElement::org::multipoly::User::User::usertype",/* persistentName */ "usertype",/* inverseName */ "user",/* inverseQualifiedName */ "RootElement::org::multipoly::User::ROLE::user",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ true,/* manyEnumeration */ false,/* isControllingSide */ false,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("user_role"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ -1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ ROLE.class,/* json */ "{\"name\": \"usertype\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::usertype\", \"persistentName\": \"usertype\", \"inverseName\": \"user\", \"inverseQualifiedName\": \"RootElement::org::multipoly::User::ROLE::user\", \"manyPrimitive\": false, \"oneEnumeration\": true, \"manyEnumeration\": false, \"controllingSide\": false, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": -1, \"label\": \"user_role\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/usertype\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/usertype\", \"tumlMetaDataUri\": \"/RootElement/rOLEMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/usertype",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/usertype",/* tumlMetaDataUri */ "/RootElement/rOLEMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		Email(/* qualifiedName */ "RootElement::org::multipoly::User::User::Email",/* persistentName */ "Email",/* inverseName */ "inverseOf::Email",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::Email",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Email"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Email\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::Email\", \"persistentName\": \"Email\", \"inverseName\": \"inverseOf::Email\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::Email\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Email\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/Email\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/Email\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/Email",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/Email",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		LastLoggedIn(/* qualifiedName */ "RootElement::org::multipoly::User::User::LastLoggedIn",/* persistentName */ "LastLoggedIn",/* inverseName */ "inverseOf::LastLoggedIn",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::User::User::LastLoggedIn",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("LastLoggedIn"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Integer.class,/* json */ "{\"name\": \"LastLoggedIn\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::LastLoggedIn\", \"persistentName\": \"LastLoggedIn\", \"inverseName\": \"inverseOf::LastLoggedIn\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::User::User::LastLoggedIn\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"LastLoggedIn\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/LastLoggedIn\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/LastLoggedIn\", \"tumlMetaDataUri\": \"/RootElement/integerMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/LastLoggedIn",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/LastLoggedIn",/* tumlMetaDataUri */ "/RootElement/integerMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		...
		static public String asJson() {
			...
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"name\": \"User\", ");
			sb.append("\"qualifiedName\": \"RootElement::org::multipoly::User::User\", ");
		...
		static public UserRuntimePropertyEnum fromInverseQualifiedName(String inverseQualifiedName) {
			...
			if ( Email.getInverseQualifiedName().equals(inverseQualifiedName) ) {
				return Email;
			}
			if ( usertype.getInverseQualifiedName().equals(inverseQualifiedName) ) {
				return usertype;
			}
			if ( usergroup.getInverseQualifiedName().equals(inverseQualifiedName) ) {
				return usergroup;
			}
			if ( Surname.getInverseQualifiedName().equals(inverseQualifiedName) ) {
				return Surname;
			}
			if ( Rogue.getInverseQualifiedName().equals(inverseQualifiedName) ) {
				return Rogue;
			}
			if ( LastLoggedOut.getInverseQualifiedName().equals(inverseQualifiedName) ) {
		...
		static public UserRuntimePropertyEnum fromLabel(String _label) {
			...
			if ( Email.getLabel().equals(_label) ) {
				return Email;
			}
			if ( usertype.getLabel().equals(_label) ) {
				return usertype;
			}
			if ( usergroup.getLabel().equals(_label) ) {
				return usergroup;
			}
			if ( Surname.getLabel().equals(_label) ) {
				return Surname;
			}
			if ( Rogue.getLabel().equals(_label) ) {
				return Rogue;
			}
			if ( LastLoggedOut.getLabel().equals(_label) ) {
				return LastLoggedOut;
			}
		...
		static public UserRuntimePropertyEnum fromQualifiedName(String qualifiedName) {
			...
			if ( Email.getQualifiedName().equals(qualifiedName) ) {
				return Email;
			}
			if ( usertype.getQualifiedName().equals(qualifiedName) ) {
				return usertype;
			}
			if ( usergroup.getQualifiedName().equals(qualifiedName) ) {
				return usergroup;
			}
			if ( Surname.getQualifiedName().equals(qualifiedName) ) {
				return Surname;
			}
			if ( Rogue.getQualifiedName().equals(qualifiedName) ) {
				return Rogue;
			}
			if ( LastLoggedOut.getQualifiedName().equals(qualifiedName) ) {
				return LastLoggedOut;
			}
		...
		public String getLookupFor_user_board() {
