...
import org.multipoly.Board.AssetType.AssetTypeRuntimePropertyEnum;
...
public class AssetType_assettype_asset_ServerResourceImpl extends ServerResource {
	private Object assettypeId;

	/**
	 * default constructor for AssetType_assettype_asset_ServerResourceImpl
	 */
	public AssetType_assettype_asset_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			json.append("],");
			json.append(" \"meta\" : {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::AssetType::asset\"");
	...
	public Representation options() throws ResourceException {
		try {
			...
			json.append(", \"from\": ");
			json.append(AssetTypeRuntimePropertyEnum.asJson());
			json.append("}}");
			json.append("]");
			return new JsonRepresentation(json.toString());
		} finally {
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends Asset> baseClass : resultMap.keySet() ) {
				...
				result.append("],");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::AssetType::asset\"");
				result.append(", \"to\": ");
				if ( baseClass.equals(Asset.class) ) {
					result.append(AssetRuntimePropertyEnum.asJson());
					result.append(", \"from\": ");
					result.append(AssetTypeRuntimePropertyEnum.asJson());
					result.append("}");
					result.append("");
				} else {
	...
	private void add(Map<Class<? extends Asset>,List<UmlgNodeJsonHolder>> resultMap, AssetType parentResource, Map<String,Object> propertyMap) {
