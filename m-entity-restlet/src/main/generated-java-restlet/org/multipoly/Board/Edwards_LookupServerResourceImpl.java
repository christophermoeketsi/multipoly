...
public class Edwards_LookupServerResourceImpl extends ServerResource implements Edwards_LookupServerResource {


	/**
	 * default constructor for Edwards_LookupServerResourceImpl
	 */
	public Edwards_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(Map<String,Object> propertyMap) {
		Edward childResource = new Edward(true);
