...
public class Board_board_edward_LookupServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_edward_LookupServerResourceImpl
	 */
	public Board_board_edward_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(Board parentResource, Map<String,Object> propertyMap) {
