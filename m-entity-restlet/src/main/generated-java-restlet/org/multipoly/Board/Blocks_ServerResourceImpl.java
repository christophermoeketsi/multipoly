...
public class Blocks_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for Blocks_ServerResourceImpl
	 */
	public Blocks_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<Block> resource = (UmlgSet<Block>)Block.allInstances();
			json.append("[");
			json.append("{\"data\": [");
