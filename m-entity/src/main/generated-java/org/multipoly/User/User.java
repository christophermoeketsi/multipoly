...
public class User extends BaseUmlgCompositionNode implements UmlgRestletNode, UmlgRootNode, CompositionNode {
	...
	private UmlgSet<UserType> usertype;
	...
	public void addToUsertypeIgnoreInverse(UserType usertype) {
		if ( !this.usertype.isEmpty() ) {
			throw new RuntimeException("Property is a one and already has value, first clear it before adding!");
		}
		if ( usertype != null ) {
	...
	public void fromJsonDataTypeAndComposite(Map<String,Object> propertyMap) {
		...
		if ( propertyMap.containsKey("usertype") ) {
			if ( propertyMap.get("usertype") != null ) {
				UserType usertype = UserType.fromJson((String)propertyMap.get("usertype"));
	...
	public UserType getUsertype() {
		UmlgSet<UserType> tmp = this.usertype;
		if ( !tmp.isEmpty() ) {
			return tmp.iterator().next();
		} else {
			return null;
	...
	public void initialiseProperties() {
		...
		this.usertype =  new UmlgSetImpl<UserType>(this, UserRuntimePropertyEnum.usertype);
	...
	public void removeFromUsertype(UmlgSet<UserType> usertype) {
		if ( !usertype.isEmpty() ) {
			this.usertype.removeAll(usertype);
		}
	}
	
	public void removeFromUsertype(UserType usertype) {
		if ( usertype != null ) {
	...
	public List<UmlgConstraintViolation> validateUsertype(UserType usertype) {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		return result;
	}
	...
	static public enum UserRuntimePropertyEnum implements UmlgRuntimeProperty {
		...
		usertype(/* qualifiedName */ "RootElement::org::multipoly::User::User::usertype",/* persistentName */ "usertype",/* inverseName */ "user",/* inverseQualifiedName */ "RootElement::org::multipoly::User::UserType::user",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ true,/* manyEnumeration */ false,/* isControllingSide */ false,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("user_usertype"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ -1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ UserType.class,/* json */ "{\"name\": \"usertype\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::User::User::usertype\", \"persistentName\": \"usertype\", \"inverseName\": \"user\", \"inverseQualifiedName\": \"RootElement::org::multipoly::User::UserType::user\", \"manyPrimitive\": false, \"oneEnumeration\": true, \"manyEnumeration\": false, \"controllingSide\": false, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": -1, \"label\": \"user_usertype\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/users/{userId}/usertype\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/users/{userId}/usertype\", \"tumlMetaDataUri\": \"/RootElement/userTypeMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/users/{userId}/usertype",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/users/{userId}/usertype",/* tumlMetaDataUri */ "/RootElement/userTypeMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
