...
public class Board_board_block_LookupServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_block_LookupServerResourceImpl
	 */
	public Board_board_block_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
