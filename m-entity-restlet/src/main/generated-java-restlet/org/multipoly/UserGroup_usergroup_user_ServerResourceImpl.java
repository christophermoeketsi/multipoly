...
public class UserGroup_usergroup_user_ServerResourceImpl extends ServerResource {
	private Object usergroupId;

	/**
	 * default constructor for UserGroup_usergroup_user_ServerResourceImpl
	 */
	public UserGroup_usergroup_user_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UserGroup parentResource = UMLG.get().getEntity(usergroupId);
			...
			json.append("],");
			json.append(" \"meta\" : {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::UserGroup::user\"");
			json.append(",\"qualifiedNameFrom\": \"" + parentResource.getQualifiedName() + "\"");
			json.append(",\"qualifiedNameTo\": \"RootElement::org::multipoly::User\"");
			json.append("}");
			json.append("}]");
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends User> baseClass : resultMap.keySet() ) {
				...
				result.append("],");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::UserGroup::user\"");
				result.append(", \"to\": ");
	...
	private void add(Map<Class<? extends User>,List<UmlgNodeJsonHolder>> resultMap, UserGroup parentResource, Map<String,Object> propertyMap) {
	...
	private void delete(UserGroup parentResource, Map<String,Object> propertyMap) {
		Object id = propertyMap.get("id");
		User childResource = UMLG.get().getEntity(id);
