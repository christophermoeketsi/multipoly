...
public class Block_block_asset_LookupServerResourceImpl extends ServerResource {
	private Object blockId;

	/**
	 * default constructor for Block_block_asset_LookupServerResourceImpl
	 */
	public Block_block_asset_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(Block parentResource, Map<String,Object> propertyMap) {
