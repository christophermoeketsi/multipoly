...
public class NOTIFICATIONTYPE_notificationtype_notification_LookupServerResourceImpl extends ServerResource {
	private Object notificationtypeId;

	/**
	 * default constructor for NOTIFICATIONTYPE_notificationtype_notification_LookupServerResourceImpl
	 */
	public NOTIFICATIONTYPE_notificationtype_notification_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(NOTIFICATIONTYPE parentResource, Map<String,Object> propertyMap) {
