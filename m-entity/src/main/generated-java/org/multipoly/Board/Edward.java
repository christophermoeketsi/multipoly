...
public class Edward extends BaseUmlgCompositionNode implements UmlgRestletNode, UmlgRootNode, CompositionNode {
	...
	/**
	 * constructor for Edward
	 * 
	 * @param id 
	 */
	public Edward(Object id)  {
		super(id);
	}
	 ...
	 * @param vertex 
	 */
	public Edward(Vertex vertex)  {
		super(vertex);
	}
	
	/**
	 * default constructor for Edward
	 */
	public Edward()  {
		this(true);
	}
	 ...
	 * @param persistent 
	 */
	public Edward(Boolean persistent)  {
		super(persistent);
	...
	public void addToBoard(Board board) {
		if ( board != null ) {
			if ( !this.board.isEmpty() ) {
				throw new RuntimeException("Property RootElement::org::multipoly::Board::Edward::boardis a one and already has a value!");
			}
	...
	static public UmlgSet<? extends Edward> allInstances(Filter filter) {
		UmlgSet<Edward> result = new UmlgMemorySet<Edward>();
		result.addAll(UMLG.get().allInstances(Edward.class.getName(), filter));
		return result;
	}
	
	static public UmlgSet<? extends Edward> allInstances() {
		UmlgSet<Edward> result = new UmlgMemorySet<Edward>();
		result.addAll(UMLG.get().allInstances(Edward.class.getName()));
		return result;
	}
	...
	public String getEdgeToRootLabel() {
		return UmlgLabelConverterFactory.getUmlgLabelConverter().convert("root_Edward");
	}
	
	@Override
	public String getMetaDataAsJson() {
		return Edward.EdwardRuntimePropertyEnum.asJson();
	}
	
	public UmlgMetaNode getMetaNode() {
		return EdwardMeta.getInstance();
	}
	...
	public String getQualifiedName() {
		return "RootElement::org::multipoly::Board::Edward";
	}
	...
	public List<Qualifier> getQualifiers(UmlgRuntimeProperty tumlRuntimeProperty, UmlgNode node, boolean inverse) {
		...
		EdwardRuntimePropertyEnum runtimeProperty;
		if ( !inverse ) {
			runtimeProperty = EdwardRuntimePropertyEnum.fromQualifiedName(tumlRuntimeProperty.getQualifiedName());
		} else {
			runtimeProperty = EdwardRuntimePropertyEnum.fromQualifiedName(tumlRuntimeProperty.getInverseQualifiedName());
		}
	...
	public String getUri() {
		return ("\"" + EdwardRuntimePropertyEnum.getUriToObject() + "\"");
	}
	...
	public void initialiseProperties() {
		this.board =  new UmlgSetImpl<Board>(this, EdwardRuntimePropertyEnum.board);
		this.Name =  new UmlgSetImpl<String>(this, EdwardRuntimePropertyEnum.Name);
	}
	...
	public void setBoard(Board board) {
		if ( board != null ) {
			board.clearEdward();
			board.initialiseProperty(BoardRuntimePropertyEnum.edward, false);
		}
		clearBoard();
		addToBoard(board);
	}
	...
	public List<UmlgConstraintViolation> validateMultiplicities() {
		List<UmlgConstraintViolation> result = new ArrayList<UmlgConstraintViolation>();
		if ( getBoard() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::Board::Edward::board", "lower multiplicity is 1"));
		}
		if ( getName() == null ) {
			result.add(new UmlgConstraintViolation("multiplicity", "RootElement::org::multipoly::Board::Edward::Name", "lower multiplicity is 1"));
		}
		return result;
	}
	...
	static public enum EdwardRuntimePropertyEnum implements UmlgRuntimeProperty {
		board(/* qualifiedName */ "RootElement::org::multipoly::Board::Edward::board",/* persistentName */ "board",/* inverseName */ "edward",/* inverseQualifiedName */ "RootElement::org::multipoly::Board::Board::edward",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ false,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("eddie_board"),/* isOneToOne */ true,/* isOneToMany */ false,/* isManyToOne */ false,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Board.class,/* json */ "{\"name\": \"board\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::Board::Edward::board\", \"persistentName\": \"board\", \"inverseName\": \"edward\", \"inverseQualifiedName\": \"RootElement::org::multipoly::Board::Board::edward\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": false, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"eddie_board\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/edwards/{edwardId}/board\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/edwards/{edwardId}/board\", \"tumlMetaDataUri\": \"/RootElement/boardMetaData\", \"fieldType\": \"" + FieldType.Integer + "\", \"tumlLookupUri\": \"/RootElement/edwards/{edwardId}/lookupFor_edward_board\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/edwards/{edwardId}/board",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/edwards/{edwardId}/board",/* tumlMetaDataUri */ "/RootElement/boardMetaData",/* fieldType */ FieldType.Integer,/* tumlLookupUri */ "/RootElement/edwards/{edwardId}/lookupFor_edward_board",/* tumlCompositeParentLookupUri */ ""),
		Name(/* qualifiedName */ "RootElement::org::multipoly::Board::Edward::Name",/* persistentName */ "Name",/* inverseName */ "inverseOf::Name",/* inverseQualifiedName */ "inverseOf::RootElement::org::multipoly::Board::Edward::Name",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ true,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("Name"),/* isOneToOne */ false,/* isOneToMany */ false,/* isManyToOne */ true,/* isManyToMany */ false,/* upper */ 1,/* lower */ 1,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ String.class,/* json */ "{\"name\": \"Name\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": true, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::Board::Edward::Name\", \"persistentName\": \"Name\", \"inverseName\": \"inverseOf::Name\", \"inverseQualifiedName\": \"inverseOf::RootElement::org::multipoly::Board::Edward::Name\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": false, \"manyToOne\": true, \"manyToMany\": false, \"upper\": 1, \"lower\": 1, \"inverseUpper\": 1, \"label\": \"Name\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": false, \"derived\": false, \"navigable\": true, \"tumlUri\": \"/RootElement/edwards/{edwardId}/Name\", \"tumlOverloadedPostUri\": \"/RootElement/overloadedpost/edwards/{edwardId}/Name\", \"tumlMetaDataUri\": \"/RootElement/stringMetaData\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement/edwards/{edwardId}/Name",/* tumlOverloadedPostUri */ "/RootElement/overloadedpost/edwards/{edwardId}/Name",/* tumlMetaDataUri */ "/RootElement/stringMetaData",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		RootElement(/* qualifiedName */ "RootElement",/* persistentName */ "RootElement",/* inverseName */ "inverseOfRootElement",/* inverseQualifiedName */ "inverseOfRootElement",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ true,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("rootEdward"),/* isOneToOne */ true,/* isOneToMany */ false,/* isManyToOne */ false,/* isManyToMany */ false,/* upper */ -1,/* lower */ 0,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ false,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ false,/* propertyType */ Object.class,/* json */ "{\"name\": \"RootElement\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement\", \"persistentName\": \"RootElement\", \"inverseName\": \"inverseOfRootElement\", \"inverseQualifiedName\": \"inverseOfRootElement\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": true, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": -1, \"lower\": 0, \"inverseUpper\": 1, \"label\": \"rootEdward\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": false, \"inverseUnique\": false, \"derived\": false, \"navigable\": false, \"tumlUri\": \"/RootElement\", \"tumlOverloadedPostUri\": \"/RootElement\", \"tumlMetaDataUri\": \"\", \"fieldType\": \"" + FieldType.String + "\", \"tumlLookupUri\": \"\", \"tumlCompositeParentLookupUri\": \"\"}",/* isChangeListenerAttribute */ false,/* tumlUri */ "/RootElement",/* tumlOverloadedPostUri */ "/RootElement",/* tumlMetaDataUri */ "",/* fieldType */ FieldType.String,/* tumlLookupUri */ "",/* tumlCompositeParentLookupUri */ ""),
		...
		/**
		 * constructor for EdwardRuntimePropertyEnum
		 * 
		...
		static public String asJson() {
			int count = 1;
			StringBuilder sb = new StringBuilder();;
			sb.append("{\"name\": \"Edward\", ");
			sb.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::Edward\", ");
			sb.append("\"uri\": \"" + getUriToObject() + "\", ");
			sb.append("\"properties\": [");
			for ( EdwardRuntimePropertyEnum l : EdwardRuntimePropertyEnum.values() ) {
				sb.append(l.toJson());
				if ( count < EdwardRuntimePropertyEnum.values().length ) {
					count++;
					sb.append(",");
				}
			}
		...
		static public EdwardRuntimePropertyEnum fromInverseQualifiedName(String inverseQualifiedName) {
		...
		static public EdwardRuntimePropertyEnum fromLabel(String _label) {
		...
		static public EdwardRuntimePropertyEnum fromQualifiedName(String qualifiedName) {
		...
		public String getLookupFor_edward_board() {
		...
		static public String getUriToObject() {
			return "/RootElement/edwards/{edwardId}";
		}
