...
public class Edwards_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for Edwards_ServerResourceImpl
	 */
	public Edwards_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<Edward> resource = (UmlgSet<Edward>)Edward.allInstances();
			json.append("[");
			json.append("{\"data\": [");
