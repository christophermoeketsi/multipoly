...
public enum NOTIFICATIONTYPE implements UmlgEnum {
	PERSONAL,
	BOARD,
	ALL;
	...
	static public NOTIFICATIONTYPE fromJson(String json) {
		if ( json == null || json.equals("null") ) {
			return null;
		} else {
			return NOTIFICATIONTYPE.valueOf(json);
		}
	}
	...
	static public enum NOTIFICATIONTYPERuntimePropertyEnum implements UmlgRuntimeProperty {
		...
		/**
		 * constructor for NOTIFICATIONTYPERuntimePropertyEnum
		 * 
		...
		static public String asJson() {
			...
			sb.append("{\"name\": \"NOTIFICATIONTYPE\", ");
			sb.append("\"qualifiedName\": \"RootElement::org::multipoly::Notification::NOTIFICATIONTYPE\", ");
			sb.append("\"uri\": \"TODO\", ");
			sb.append("\"properties\": [");
			for ( NOTIFICATIONTYPERuntimePropertyEnum l : NOTIFICATIONTYPERuntimePropertyEnum.values() ) {
				sb.append(l.toJson());
				if ( count < NOTIFICATIONTYPERuntimePropertyEnum.values().length ) {
					count++;
					sb.append(",");
				}
			}
		...
		static public NOTIFICATIONTYPERuntimePropertyEnum fromInverseQualifiedName(String inverseQualifiedName) {
		...
		static public NOTIFICATIONTYPERuntimePropertyEnum fromLabel(String _label) {
