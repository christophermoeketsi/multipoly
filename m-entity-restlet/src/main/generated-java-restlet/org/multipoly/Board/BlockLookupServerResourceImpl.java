...
public class BlockLookupServerResourceImpl extends ServerResource {
	private Object blockId;

	/**
	 * default constructor for BlockLookupServerResourceImpl
	 */
	public BlockLookupServerResourceImpl()  {
		setNegotiated(false);
	}
