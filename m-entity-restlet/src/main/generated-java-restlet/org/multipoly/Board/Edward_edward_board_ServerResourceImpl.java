...
public class Edward_edward_board_ServerResourceImpl extends ServerResource {
	private Object edwardId;

	/**
	 * default constructor for Edward_edward_board_ServerResourceImpl
	 */
	public Edward_edward_board_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends Board> baseClass : resultMap.keySet() ) {
				...
				result.append(",");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::Edward::board\"");
				result.append(", \"to\": ");
	...
	private void add(Map<Class<? extends Board>,List<UmlgNodeJsonHolder>> resultMap, Edward parentResource, Map<String,Object> propertyMap) {
