...
public class Asset_asset_board_ServerResourceImpl extends ServerResource {
	private Object assetId;

	/**
	 * default constructor for Asset_asset_board_ServerResourceImpl
	 */
	public Asset_asset_board_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends Board> baseClass : resultMap.keySet() ) {
				...
				result.append("],");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::Asset::board\"");
				result.append(", \"to\": ");
	...
	private void add(Map<Class<? extends Board>,List<UmlgNodeJsonHolder>> resultMap, Asset parentResource, Map<String,Object> propertyMap) {
