...
import org.multipoly.User.ROLE.ROLERuntimePropertyEnum;
...
public class ROLE_usertype_user_ServerResourceImpl extends ServerResource {
	...
	public Representation get() throws ResourceException {
		try {
			...
			json.append("],");
			json.append(" \"meta\" : {");
			json.append("\"qualifiedName\": \"RootElement::org::multipoly::User::ROLE::user\"");
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends User> baseClass : resultMap.keySet() ) {
				...
				result.append("],");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::User::ROLE::user\"");
				result.append(", \"to\": ");
