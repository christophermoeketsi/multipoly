...
public class UserGroup_usergroup_user_LookupServerResourceImpl extends ServerResource {
	private Object usergroupId;

	/**
	 * default constructor for UserGroup_usergroup_user_LookupServerResourceImpl
	 */
	public UserGroup_usergroup_user_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(UserGroup parentResource, Map<String,Object> propertyMap) {
