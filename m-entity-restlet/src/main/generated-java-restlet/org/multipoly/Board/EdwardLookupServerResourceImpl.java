...
public class EdwardLookupServerResourceImpl extends ServerResource {
	private Object edwardId;

	/**
	 * default constructor for EdwardLookupServerResourceImpl
	 */
	public EdwardLookupServerResourceImpl()  {
		setNegotiated(false);
	}
