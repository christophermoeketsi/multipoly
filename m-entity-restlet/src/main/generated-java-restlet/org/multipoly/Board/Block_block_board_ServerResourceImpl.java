...
public class Block_block_board_ServerResourceImpl extends ServerResource {
	private Object blockId;

	/**
	 * default constructor for Block_block_board_ServerResourceImpl
	 */
	public Block_block_board_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation post(Representation entity) throws ResourceException {
		...
		try {
			...
			for ( Class<? extends Board> baseClass : resultMap.keySet() ) {
				...
				result.append(",");
				result.append(" \"meta\" : {");
				result.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::Block::board\"");
				result.append(", \"to\": ");
	...
	private void add(Map<Class<? extends Board>,List<UmlgNodeJsonHolder>> resultMap, Block parentResource, Map<String,Object> propertyMap) {
