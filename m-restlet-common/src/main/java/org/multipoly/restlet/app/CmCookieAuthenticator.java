...
public class CmCookieAuthenticator extends CookieAuthenticator {
    ...
    private static CmCookieAuthenticator cmCookieAuthenticator;

    public static CmCookieAuthenticator get(Context context, String realm, byte[] encryptSecretKey) {
        if (cmCookieAuthenticator == null) {
            cmCookieAuthenticator = new CmCookieAuthenticator(context, realm, encryptSecretKey);
        }
        return cmCookieAuthenticator;
    }

    public static CmCookieAuthenticator get() {
        return cmCookieAuthenticator;
    }

    private CmCookieAuthenticator(Context context, String realm, byte[] encryptSecretKey) {
