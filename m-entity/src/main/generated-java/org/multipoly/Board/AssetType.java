...
public enum AssetType implements UmlgEnum {
	HOUSE,
	HOTEL,
	ELECTRICITY_UTILTY,
	WATER_UTITLTY,
	...
	static public AssetType fromJson(String json) {
		if ( json == null || json.equals("null") ) {
			return null;
		} else {
			return AssetType.valueOf(json);
		}
	}
	 ...
	 */
	public UmlgSetClosableIterableImpl<Asset> getAsset() {
		GraphTraversalSource graph = UMLG.get().getUnderlyingGraph().traversal();
		GraphTraversal<Vertex, Vertex> traversal = graph.V().has("Asset", "assettype", P.within(name()));
		return new UmlgSetClosableIterableImpl<>(traversal, AssetTypeRuntimePropertyEnum.asset);
	}
	
	@Override
	public String getQualifiedName() {
		return "RootElement::org::multipoly::Board::AssetType";
	}
	...
	static public enum AssetTypeRuntimePropertyEnum implements UmlgRuntimeProperty {
		asset(/* qualifiedName */ "RootElement::org::multipoly::Board::AssetType::asset",/* persistentName */ "asset",/* inverseName */ "assettype",/* inverseQualifiedName */ "RootElement::org::multipoly::Board::Asset::assettype",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ false,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("asset_assetType"),/* isOneToOne */ false,/* isOneToMany */ true,/* isManyToOne */ false,/* isManyToMany */ false,/* upper */ -1,/* lower */ 0,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ true,/* isInverseUnique */ true,/* isDerived */ false,/* isNavigable */ true,/* propertyType */ Asset.class,/* json */ "{\"name\": \"asset\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement::org::multipoly::Board::AssetType::asset\", \"persistentName\": \"asset\", \"inverseName\": \"assettype\", \"inverseQualifiedName\": \"RootElement::org::multipoly::Board::Asset::assettype\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": false, \"oneToOne\": false, \"oneToMany\": true, \"manyToOne\": false, \"manyToMany\": false, \"upper\": -1, \"lower\": 0, \"inverseUpper\": 1, \"label\": \"asset_assetType\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": true, \"inverseUnique\": true, \"derived\": false, \"navigable\": true}",/* isChangeListenerAttribute */ false),
		RootElement(/* qualifiedName */ "RootElement",/* persistentName */ "RootElement",/* inverseName */ "inverseOfRootElement",/* inverseQualifiedName */ "inverseOfRootElement",/* isAssociationClassOne */ false,/* isMemberEndOfAssociationClass */ false,/* associationClassPropertyNameField */ "null",/* inverseAssociationClassPropertyNameField */ "null",/* isAssociationClassProperty */ false,/* isOnePrimitivePropertyOfAssociationClass */ false,/* isOnePrimitive */ false,/* isReadOnly */ false,/* dataTypeEnum */ null,/* validations */ Collections.<UmlgValidation>emptyList(),/* isManyPrimitive */ false,/* oneEnumeration */ false,/* manyEnumeration */ false,/* isControllingSide */ true,/* isComposite */ false,/* isInverseComposite */ true,/* label */ UmlgLabelConverterFactory.getUmlgLabelConverter().convert("rootAssetType"),/* isOneToOne */ true,/* isOneToMany */ false,/* isManyToOne */ false,/* isManyToMany */ false,/* upper */ -1,/* lower */ 0,/* inverseUpper */ 1,/* isQualified */ false,/* isInverseQualified */ false,/* isOrdered */ false,/* isInverseOrdered */ false,/* isUnique */ false,/* isInverseUnique */ false,/* isDerived */ false,/* isNavigable */ false,/* propertyType */ Object.class,/* json */ "{\"name\": \"RootElement\", \"associationClassOne\": false, \"memberEndOfAssociationClass\": false, \"associationClassPropertyName\": null, \"inverseAssociationClassPropertyName\": null, \"associationClassProperty\": false, \"onePrimitivePropertyOfAssociationClass\": false, \"onePrimitive\": false, \"readOnly\": false, \"dataTypeEnum\": null, \"validations\": null, \"qualifiedName\": \"RootElement\", \"persistentName\": \"RootElement\", \"inverseName\": \"inverseOfRootElement\", \"inverseQualifiedName\": \"inverseOfRootElement\", \"manyPrimitive\": false, \"oneEnumeration\": false, \"manyEnumeration\": false, \"controllingSide\": true, \"composite\": false, \"inverseComposite\": true, \"oneToOne\": true, \"oneToMany\": false, \"manyToOne\": false, \"manyToMany\": false, \"upper\": -1, \"lower\": 0, \"inverseUpper\": 1, \"label\": \"rootAssetType\", \"qualified\": false, \"inverseQualified\": false, \"ordered\": false, \"inverseOrdered\": false, \"unique\": false, \"inverseUnique\": false, \"derived\": false, \"navigable\": false}",/* isChangeListenerAttribute */ false);
		...
		/**
		 * constructor for AssetTypeRuntimePropertyEnum
		 * 
		...
		static public String asJson() {
			...
			sb.append("{\"name\": \"AssetType\", ");
			sb.append("\"qualifiedName\": \"RootElement::org::multipoly::Board::AssetType\", ");
			sb.append("\"uri\": \"TODO\", ");
			sb.append("\"properties\": [");
			for ( AssetTypeRuntimePropertyEnum l : AssetTypeRuntimePropertyEnum.values() ) {
				sb.append(l.toJson());
				if ( count < AssetTypeRuntimePropertyEnum.values().length ) {
					count++;
					sb.append(",");
				}
			}
		...
		static public AssetTypeRuntimePropertyEnum fromInverseQualifiedName(String inverseQualifiedName) {
		...
		static public AssetTypeRuntimePropertyEnum fromLabel(String _label) {
		...
		static public AssetTypeRuntimePropertyEnum fromQualifiedName(String qualifiedName) {
