...
public class UserType_usertype_user_LookupServerResourceImpl extends ServerResource {
	private Object usertypeId;

	/**
	 * default constructor for UserType_usertype_user_LookupServerResourceImpl
	 */
	public UserType_usertype_user_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	private void add(UserType parentResource, Map<String,Object> propertyMap) {
