...
public class Board_board_user_LookupServerResourceImpl extends ServerResource {
	private Object boardId;

	/**
	 * default constructor for Board_board_user_LookupServerResourceImpl
	 */
	public Board_board_user_LookupServerResourceImpl()  {
		setNegotiated(false);
	}
