...
public class Boards_ServerResourceImpl extends ServerResource {


	/**
	 * default constructor for Boards_ServerResourceImpl
	 */
	public Boards_ServerResourceImpl()  {
		setNegotiated(false);
	}
	...
	public Representation get() throws ResourceException {
		try {
			...
			UmlgSet<Board> resource = (UmlgSet<Board>)Board.allInstances();
			json.append("[");
			json.append("{\"data\": [");
