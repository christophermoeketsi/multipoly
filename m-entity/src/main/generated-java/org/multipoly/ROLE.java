...
public enum ROLE implements UmlgEnum {
	...
	public void addToUser(User user) {
		if ( user != null ) {
			user.clearRole();
			user.initialiseProperty(UserRuntimePropertyEnum.role, false);
			removeFromUser(user);
		}
		if ( user != null ) {
			this.user.add(user);
	...
	public String getQualifiedName() {
		return "RootElement::org::multipoly::ROLE";
	}
	...
	static public enum ROLERuntimePropertyEnum implements UmlgRuntimeProperty {
		...
		static public String asJson() {
			...
			sb.append("{\"name\": \"ROLE\", ");
			sb.append("\"qualifiedName\": \"RootElement::org::multipoly::ROLE\", ");
			sb.append("\"uri\": \"TODO\", ");
